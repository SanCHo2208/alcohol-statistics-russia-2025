...
<body>
    ...
    <div class="container">
        ...
        <section class="share-section">
            ...
            <div>
                ...
                <a href="https://twitter.com/intent/tweet?text=Интересная статистика потребления алкоголя в России за 2025 год&url=[URL]" class="share-btn" target="_blank">Поделиться в Twitter</a>
                <a href="https://www.facebook.com/sharer/sharer.php?u=[URL]" class="share-btn" target="_blank">Поделиться в Facebook</a>
            </div>
        </section>
    </div>
    ...
    <footer>
        <div class="container">
            ...
            <p>Сайт доступен по адресу: <span id="siteUrl"></span></p>
        </div>
    </footer>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const title = encodeURIComponent('Статистика потребления алкоголя в России (2025)');
            ...
            document.getElementById('regionSelect').addEventListener('change', function() {
                ...
                if (region === 'average') {
                    ...
                    const regionName = region === 'moscow' ? 'Москва' :
                                     ...
                                     region === 'magadan' ? 'Магаданская область' : 'Чеченская Республика';
                ...
                // Обновление графика
                regionalAgeChart.data.datasets[0].data = ageData.distribution;
